...
/**
*check97 - entry point checks for the correct number of arguments
...
/**
*check98 - entry point checks that file_from exists and can be read
*@check: checks if true of false
*@file: is file_from name
...
/**
*check99 - entry point checks that file_to was created and/or can be written to
*@check: checks if true of false
*@file: is file_to name
*@fd_from: file descriptor of file_from, or -1
*@fd_to: file descriptor of file_to, or -1
*
*Return: void
...
/**
*check100 - entry point checks that file descriptors were closed properly
...
/**
*main - entry point copies the content of one file to another file.
